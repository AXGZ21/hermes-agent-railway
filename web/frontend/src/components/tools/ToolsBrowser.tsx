          ...
          <button
            ...
            className={clsx(
              ...
              selectedCategory === null
                ...
                : 'bg-surface-2 text-zinc-500 border-border hover:border-brand/30'
            )}
          >
            All ({tools.length})
          </button>
            ...
            {Object.entries(groupedTools)
              ...
              .map(([category, categoryTools]) => {
                ...
                return (
                  <div key={category}>
                    <div className="flex items-center gap-2 mb-3">
                      <h2 className="text-[13px] font-semibold text-zinc-300 uppercase tracking-widest">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2.5">
                      {categoryTools.map((tool) => (
                        <div
                          key={tool.name}
                          className="bg-surface-2 rounded-xl p-3.5 border border-border hover:border-brand/30 transition-all"
                        >
                          <div className="flex items-start justify-between gap-2 mb-2">
                            ...
                            <span
                              className={clsx(
                                'text-[9px] font-medium px-1.5 py-0.5 rounded uppercase tracking-widest flex-shrink-0 border',
                                colors.bg,
                                colors.text,
                                colors.border
                              )}
